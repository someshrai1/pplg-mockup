...
interface UsagePOUploadProps {
  onSuccess: () => void;
  packageName: string;
}

export function UsagePOUpload({ onSuccess, packageName }: UsagePOUploadProps) {
      ...
      <div className="max-w-2xl w-full">
        <Card>
          <CardHeader className="text-center">
            <CardTitle>Upload Purchase Order - Usage</CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-6">
            <Alert>
              ...
              <AlertDescription>
                Upload your signed purchase order (PDF or DOC format) to complete the usage license activation process.
              </AlertDescription>
            </Alert>
